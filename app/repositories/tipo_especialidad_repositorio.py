...
class TipoEspecialidadRepositorio:
    @staticmethod
    ...
    @staticmethod
    def actualizar(tipo_especialidad: TipoEspecialidad) -> TipoEspecialidad:
    ...
    def borrar_por_id(id: int) -> TipoEspecialidad:
        tipo_especialidad = db.session.query(
            TipoEspecialidad).filter_by(id=id).first()
