...
@certificado_bp.route('/certificado/<hashid:id>/pdf', methods=['GET'])
...
@certificado_bp.route('/certificado/<hashid:id>/odt', methods=['GET'])
...
@certificado_bp.route('/certificado/<hashid:id>/docx', methods=['GET'])
